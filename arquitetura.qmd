...
| **App React + SDK** | Verificador (você) | React 18 + `@injistack/react-inji-verify-sdk@0.17.0` | Componentes React que gerenciam o fluxo de verificação |
| **INJI Verify Service** | Verificador (você) | Java 21, Spring Boot 3.2, PostgreSQL 15 | Backend que valida criptograficamente a credencial via OpenID4VP |
...
5. O resultado chega ao SDK via callback (`onVPProcessed`)
